...
export default function ItemSaleReport() {
    ...
    const dashboardUrl = "https://crystalsolutions.com.pk/iqbaltrader/web/ItemSaleReport.php";
    ...
    useEffect(() => {
        const apiUrl = 'https://crystalsolutions.com.pk/emart/web/CategoryList.php';
        axios.post(apiUrl)
            .then(response => {
            ...
            <header
                ...
                <div style={{ marginLeft: '60px', marginRight: '20px' }}>
                    <p style={{ margin: '0', fontFamily: 'Sans-serif', fontWeight: '700', fontSize: '15px', lineHeight: '1', textAlign: 'left', color: 'white' }}>
                        Reports &nbsp;&gt;&nbsp; Item Reports &nbsp;&gt;&nbsp; Item Sales Report
                    </p>
                </div>
                    ...
                    <div className="parent ">
                        <div className="child1">
                            ...
                            <div className="d-flex align-items-center" style={{ marginLeft: '50px' }}>
                                <label   htmlFor="searchInput" style={{ paddingRight: '32px' }}><span style={{ fontSize: '10px' }}>Search:</span>  </label>
                                <input
                                    type="text"
                                    id="searchInput"
